// src/components/faculty/AttendanceTable.tsx
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-3 px-4 font-medium text-gray-900">QR</th>
            </tr>
            </thead>
            <tbody>
            {students.map((student) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-gray-600">
                    {student.checkedInAt
                        ? dayjs(student.checkedInAt).format('HH:mm:ss')
                        : '-'}
                  </td>
                  <td className="py-3 px-4">
                    <div className="w-12 h-12">
                      <QRCodeSVG
                          value={`student-${student._id}-${student.rollNumber}`}
                          size={48}
                          level="M"
                          includeMargin={false}
                      />
