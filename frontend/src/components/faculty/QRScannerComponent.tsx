...
const QRScannerComponent: React.FC<QRScannerComponentProps> = ({ onScan, isActive, onToggle }) => {
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {isActive ? (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">Click "Start Scanner" to begin marking attendance</p>
        </div>
      )}
    </div>
  );
