...
const EventForm: React.FC<EventFormProps> = ({ initialData, onSubmit, isLoading = false }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const clubs = ['Tech Club', 'Photography Club', 'Data Science Club', 'Sports Club', 'Cultural Club'];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            {...register('club')}
            id="club"
            className={`w-full pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
